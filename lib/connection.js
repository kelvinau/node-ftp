...
FTP.prototype.connect = function(options) {
  ...
  if (typeof options.keepSocketAlive !== 'undefined') {
    this.options.keepSocketAlive = !!options.keepSocketAlive;
  }
  ...
  socket.setTimeout(0);
  socket.setKeepAlive(this.options.keepSocketAlive);
